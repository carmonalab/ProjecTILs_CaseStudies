...
In this ProjecTILs case study, we combined [Seurat](https://satijalab.org/seurat/), [ProjecTILs](https://github.com/carmonalab/ProjecTILs) and [scRepertoire](https://github.com/ncborcherding/scRepertoire) into an integral scRNA-seq analysis workflow to interpret the transcriptional and clonal structure of tumor-infiltrating T cells in MC38 colon adenocarcinoma (data from [Xiong et al 2019](https://doi.org/10.1158/2326-6066.CIR-18-0750))
