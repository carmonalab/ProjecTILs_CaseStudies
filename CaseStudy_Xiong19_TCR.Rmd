...
In this case case study, we will build an integrated scRNA-seq analysis workflow to interpret the **transcriptional** and **clonal structure** of tumor-infiltrating T cells in MC38 colon adenocarcinoma (data from [Xiong et al 2019](https://doi.org/10.1158/2326-6066.CIR-18-0750)).
...
See the structure of the TCRdata, after a-b chain pairing
```{r}
head(combined[[1]])
```
...
Visualize the projections per sample. 
...
grid.arrange(grobs=plots, ncols=4)
```
